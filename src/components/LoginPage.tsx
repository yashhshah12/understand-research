...
const LoginPage = ()=>{
    ...
    return(
        ...
        <div className="border-1 rounded-2xl pt-5 px-8 z-10 font-serif max-w-md w-full bg-white shadow-md border-gray-200" >
            ...
            <p className="text-3xl text-gray-500"> Please enter your details</p>    
            </div>
            <form action="" className="flex flex-col gap-7 mt-5 mb-20 ">
            <input type="email" placeholder="Email address"  className="py-3 px-2 rounded-2xl text-xl border-gray-300"  />
            <input type="password" name="" id="" placeholder="Password" className="py-3 px-2 rounded-[15px] text-xl border-gray-300"/>
